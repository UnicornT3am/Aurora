...
dependencies {
    ...
    // WorkManager, Biometrics, Material
    ...
    implementation(libs.ktor.okhttp) // Esta línea debe ser tu dependencia de ktor-okhttp
    implementation(libs.ktor.logging)
    implementation("io.ktor:ktor-client-okhttp:2.x.x") // Añade esta línea para la dependencia okhttp de ktor
