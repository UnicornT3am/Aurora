    ...
    companion object {
        ...
        private val IZZY = defaultRepository(
            "https://apt.izzysoft.de/fdroid/repo", "IzzyOnDroid F-Droid Repo", "This is a " +
                    ...
                    "though most are checked multiple times a week ", 21, false,
        ...
        private val COLLABORA = defaultRepository(
            ...
            21, true, "573258C84E149B5F4D9299E7434B2B69A8410372921D4AE586BA91EC767892CC", ""
        )
        ...
        private val MOLLY = defaultRepository(
            ...
            21, true, "5198DAEF37FC23C14D5EE32305B2AF45787BD7DF2034DE33AD302BDB3446DF74", ""
        )
        private val BRIAR = defaultRepository(
            ...
            21, true, "1FB874BEE7276D28ECB2C9B06E8A122EC4BCB4008161436CE474C257CBF49BD6", ""
        )
        private val SIMPLEX_CHAT = defaultRepository(
            ...
            21, true, "9F358FF284D1F71656A2BFAF0E005DEAE6AA14143720E089F11FF2DDCFEB01BA", ""
        )
        ...
        private val UNISTORE = defaultRepository(
            "https://repo.onlyphones.xyz/fdroid/repo/",
            "",
            "",
            21,
            true,
            "0CA8EC517A87AA0785BC22D3D4B75369188087F02CAB2FA4D745369DE899B9BC",
            ""
        )
